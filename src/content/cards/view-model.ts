...
import { buildCardWebStyleVariables } from '../../lib/card-style-registry';
...
export const buildCardPageViewModel = ({
  ...
  const themePreset = resolveThemePreset(config.appearance.theme);
  ...
  return {
    ...
    appearance: {
      ...
      cssVariables: {
        ...
        ...buildCardWebStyleVariables(config),
      },
    },
